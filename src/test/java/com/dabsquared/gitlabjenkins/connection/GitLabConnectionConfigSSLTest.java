...
public class GitLabConnectionConfigSSLTest {
    ...
    public void doCheckConnection_ignoreCertificateErrors() {
        ...
        FormValidation formValidation = connectionConfig.doTestConnection("https://localhost:" + port + "/gitlab", null, API_TOKEN_ID, "v3", true, 10, 10);
    ...
    public void doCheckConnection_certificateError() throws IOException {
        ...
        FormValidation formValidation = connectionConfig.doTestConnection("https://localhost:" + port + "/gitlab", null, API_TOKEN_ID, "v3", false, 10, 10);
